...
antechamber -fi mol2 -fo ac -pf y -i $1 -o ${basename}_gaff.ac
elif [[ $exdname = "mpdb" || $exdname = "pqr" ]];then
antechamber -fi mpdb -fo ac -pf y -i $1 -o ${basename}_gaff.ac
else
...
if [[ $exdname = "mol2" || $exdname = "pdb" || $exdname = "ac" ]];then
antechamber -fi $exdname -fo ac -pf y -i $1 -c $chargetype -o ${basename}_gaff.ac
elif [[ $exdname = "mpdb" || $exdname = "pqr" ]];then
antechamber -fi mpdb -fo ac -pf y -i $1 -c $chargetype -o ${basename}_gaff.ac
else
echo "Only support for pdb/mol2/mpdb/pqr/ac files!"
exit
fi
